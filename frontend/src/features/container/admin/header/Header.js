    ...
    const getprofile = async () => {
        if (users) {
            ...
            setUser({
                ...
                diachi: infor.data.diachi,
                email: infor.data.email,
                gioitinh: infor.data.gioitinh,
                ngaysinh: infor.data.ngaysinh,
                sdt: infor.data.sdt,
                avatar: infor.avatar,
            })
            setState({
            ...
            {!user ? '' :
                <ul className="navbar-nav float-right" onClick={showDrawer}>
                    ...
                    <li className="nav-item ">
                        <Avatar alt="Remy Sharp" className="pick" src={user.avatar} />
                    </li>
                </ul>
            }
            {!user ? '' :
